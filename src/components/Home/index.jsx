            ...
            return (
              ...
              >
                ...
                <div className="relative p-10">
                  <p className="text-xl font-bold text-gray-700 bg-slate-100/70 pl-2 pr-2 rounded-full w-full">
                    {item.name}
                  </p>

                  <div className="mt-24 ml-5">
                    <div className="flex flex-col bg-orange-200/50 rounded-full translate-y-6 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                      <p className="text-lg font-semibold text-center text-[#70BABB] pl-2 pr-2">
                        Кухня: {item.cuisine}
                      </p>
                    </div>
                  </div>
